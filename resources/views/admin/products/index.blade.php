...
<div class="product-management-container">
    <div class="products-header-container">
        ...
        <a href="{{ $prefix }}{{ route('admin.products.add') }}" class="admin-products-add-button">商品追加</a>
    </div>
        ...
        @else
            ...
            <div class="admin-product-item">
                ...
                <div class="product-actions">
                    <form action="{{ $prefix }}{{ route('admin.products.edit', $product->id) }}" method="GET" style="display:inline;">
                        <button type="submit" class="admin-products-edit-button">編集</button>
                    </form>
                    <form action="{{ $prefix }}{{ route('admin.products.destroy', $product->id) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE')
